...
export const exerciseDatabase: Exercise[] = [ 
  ...
  // --- LEGS: Dumbbell Variants ---
  { id: 'db-goblet-squat', name: 'DB Goblet Squat', muscleGroup: 'Legs', target: 'Quads', movementPlane: 'Knee Dominant', tier: 'S', type: 'Compound', equipment: 'Dumbbell', fatigueCost: 'Medium', jointStress: 'Medium', targetReps: '10-15', tips: "Hold DB at chest. Elbows inside knees." },
  { id: 'db-rdl', name: 'DB Romanian Deadlift', muscleGroup: 'Legs', target: 'Hamstrings', movementPlane: 'Hip Hinge', tier: 'S', type: 'Compound', equipment: 'Dumbbell', fatigueCost: 'Medium', jointStress: 'Medium', targetReps: '10-15', tips: "Hips back. Keep DBs close to shins." },
  { id: 'db-leg-curl', name: 'DB Floor Leg Curl', muscleGroup: 'Legs', target: 'Hamstrings', movementPlane: 'Knee Isolation', tier: 'B', type: 'Isolation', equipment: 'Dumbbell', fatigueCost: 'Low', jointStress: 'Low', targetReps: '12-15', tips: "Squeeze DB between feet. Lay on stomach." },
  { id: 'db-bulgarian', name: 'DB Bulgarian Split Squat', muscleGroup: 'Legs', target: 'Quads/Glutes', movementPlane: 'Knee Dominant', tier: 'S', type: 'Compound', equipment: 'Dumbbell', fatigueCost: 'High', jointStress: 'High', targetReps: '8-12', tips: "Elevate back foot. Lean forward for glutes." },
